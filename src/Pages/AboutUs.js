    ...
    <div className="aboutus">
      ...
      <div className="aboutus__content">
        ...
        <span className="aboutus__content--block">
          ...
          <strong>David Thomas</strong> and <strong>Edie Bowles</strong>, two
          solicitors with vast combined experience in animal protection law, the
          firm is supported by and works closely with
          <strong>the UK Centre of Animal Law (A-LAW):</strong> Edie is a
          trustee and David a former trustee.
        </span>
        <span className="aboutus__content--block">
          Before 1822 in this country – as in many countries around the world
          still – there was no law to protect animals. A man could beat his
          horse to death simply because it was his.
        </span>
        <span className="aboutus__content--block">
          The supervening two centuries have seen a large swathe of animal
          protection legislation, some of it very good. But there is
          indisputably <strong>far more cruelty</strong> caused to animals by
          human beings today than two hundred years ago.
        </span>
        <span className="aboutus__content--block">
          Attitudes are generally more enlightened, and there is less domestic
          cruelty, but technological developments mean that we can do things to
          animals today that we could not hitherto – in factory farms (where
          literally billions languish), in laboratories and so forth, far from
          public gaze. Millions of animals are transported as cargo across the
          world for various purposes.
        </span>
        <span className="aboutus__content--block">
          It is therefore essential that animal protection NGOs make maximum use
          of the tools at their disposal, as environmental groups and many
          social justice organisations already do very effectively.{" "}
          <strong>Advocates for Animals</strong> is committed to the creative
          use of the law – alongside investigations, science, lobbying, social
          and traditional media – to make a huge difference to the lives of
          animals.
        </span>
      </div>
